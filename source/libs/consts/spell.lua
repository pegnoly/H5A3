...
---|`SPELL_EFFECT_CATAPULT_CHARGE_EXPLOSION`
---|`SPELL_EFFECT_FROZEN`
---|`SPELL_EFFECT_FIRE_DAMAGE`
---|`SPELL_EFFECT_LAND_MINE_EXPLOSION`
---|`SPELL_EFFECT_PHANTOM_OUT`
---|`SPELL_EFFECT_FIRE_SHIELD`
---|`SPELL_EFFECT_DIMENSION_DOOR_END`
...
---|`SPELL_SUMMON_AIR_ELEMENTALS`
---|`SPELL_SUMMON_EARTH_ELEMENTALS`
---|`SPELL_SUMMON_FIRE_ELEMENTALS`
---|`SPELL_SUMMON_WATER_ELEMENTALS`
SPELL_NONE = 0;
SPELL_MAGIC_ARROW = 1;
SPELL_MAGIC_FIST = 2;
...
SPELL_SUMMON_AIR_ELEMENTALS = 378
SPELL_SUMMON_EARTH_ELEMENTALS = 379
SPELL_SUMMON_FIRE_ELEMENTALS = 380
SPELL_SUMMON_WATER_ELEMENTALS = 381
